      ...
      itinerary: <DayPlan>[
        DayPlan(1, 'Arrival & Sunset Bliss', <Activity>[
          ...
          Activity('5:00 PM', 'Welcome cocktail & lagoon swim', 'Beach Bar',
              'coffee'),
          Activity('7:30 PM', 'Dinner at undersea restaurant', 'Ithaa Undersea',
              'food', 'Book 3 months in advance!'),
        ]),
    ...
    Trip(
      ...
      itinerary: <DayPlan>[
        DayPlan(1, 'Zurich Arrival & Old Town', <Activity>[
          ...
          Activity('4:00 PM', 'Stroll along Limmat River', 'Niederdorf Quarter',
              'activity'),
          Activity('7:00 PM', 'Traditional Swiss fondue dinner',
              'Hiltl Restaurant', 'food'),
        ]),
        DayPlan(2, 'Interlaken & Jungfrau', <Activity>[
          Activity('8:00 AM', 'Train to Interlaken', 'Zurich HB to Interlaken',
              'transport'),
          Activity('10:30 AM', 'Cable car to Jungfraujoch', 'Top of Europe',
              'activity', 'Wear warm layers.'),
    ...
    Trip(
      ...
      itinerary: <DayPlan>[
        ...
        DayPlan(2, 'Museums & Art Nouveau', <Activity>[
          Activity('10:00 AM', 'Magritte Museum', 'Royal Museums of Fine Arts',
              'activity'),
    ...
    Trip(
      ...
      itinerary: <DayPlan>[
        DayPlan(1, 'Arrival & Beach Day', <Activity>[
          Activity('1:00 PM', 'Check-in at beachfront resort', 'Chaweng Beach',
              'hotel'),
          Activity('6:00 PM', 'Sunset cocktails', 'Beach Club Bar', 'coffee'),
          Activity('8:00 PM', 'Thai street food feast', 'Chaweng Night Market',
              'food', 'Pad Thai and mango sticky rice.'),
        ]),
      ...
      places: <Place>[
        Place('Chaweng Beach', 'Beach', 4.6, 'Best swimming on the north end.'),
